...
var successDisplay = function successDisplay(message) {
...
var failureDisplay = function failureDisplay(message) {
  $('#error-message').html('');
...
var showGamesSuccess = function showGamesSuccess(data) {
  ...
  var sorted = data.games.sort(function (a, b) {
    return a.id - b.id;
  });
  // print all sorted games
  sorted.forEach(function (game) {
    var winner = winConsOld(game);
    // console.log(game.id)
    var over = game.over ? 'Yes' : 'No';
    $('.show-stats').append('<p>Game ID: ' + game.id + '</p><p>Game Completed? ' + over + '</p><p>Winner: ' + winner + '</p><hr>');
  });
};

// figure out winner of finished game.
var winConsOld = function winConsOld(loopvar) {
  if (loopvar.cells[0] === 'x' && loopvar.cells[0] === loopvar.cells[1] && loopvar.cells[1] === loopvar.cells[2] || loopvar.cells[3] === 'x' && loopvar.cells[3] === loopvar.cells[4] && loopvar.cells[4] === loopvar.cells[5] || loopvar.cells[6] === 'x' && loopvar.cells[6] === loopvar.cells[7] && loopvar.cells[7] === loopvar.cells[8] || loopvar.cells[0] === 'x' && loopvar.cells[0] === loopvar.cells[3] && loopvar.cells[3] === loopvar.cells[6] || loopvar.cells[1] === 'x' && loopvar.cells[1] === loopvar.cells[4] && loopvar.cells[4] === loopvar.cells[7] || loopvar.cells[2] === 'x' && loopvar.cells[2] === loopvar.cells[5] && loopvar.cells[5] === loopvar.cells[8] || loopvar.cells[0] === 'x' && loopvar.cells[0] === loopvar.cells[4] && loopvar.cells[4] === loopvar.cells[8] || loopvar.cells[6] === 'x' && loopvar.cells[6] === loopvar.cells[4] && loopvar.cells[4] === loopvar.cells[2]) {
    // const outcome = `${currentLetter.toUpperCase()} Wins!`
    // console.log('X won!')
    return 'X';
  } else if (loopvar.cells[0] === 'o' && loopvar.cells[0] === loopvar.cells[1] && loopvar.cells[1] === loopvar.cells[2] || loopvar.cells[3] === 'o' && loopvar.cells[3] === loopvar.cells[4] && loopvar.cells[4] === loopvar.cells[5] || loopvar.cells[6] === 'o' && loopvar.cells[6] === loopvar.cells[7] && loopvar.cells[7] === loopvar.cells[8] || loopvar.cells[0] === 'o' && loopvar.cells[0] === loopvar.cells[3] && loopvar.cells[3] === loopvar.cells[6] || loopvar.cells[1] === 'o' && loopvar.cells[1] === loopvar.cells[4] && loopvar.cells[4] === loopvar.cells[7] || loopvar.cells[2] === 'o' && loopvar.cells[2] === loopvar.cells[5] && loopvar.cells[5] === loopvar.cells[8] || loopvar.cells[0] === 'o' && loopvar.cells[0] === loopvar.cells[4] && loopvar.cells[4] === loopvar.cells[8] || loopvar.cells[6] === 'o' && loopvar.cells[6] === loopvar.cells[4] && loopvar.cells[4] === loopvar.cells[2]) {
    // const outcome = `${currentLetter.toUpperCase()} Wins!`
    // console.log('O won!')
    return 'O';
...
// bind all handlers
var allHandlers = function allHandlers() {
...
var showOutcome = function showOutcome(winner) {
...
var winCons = function winCons(currentLetter, numberOfMoves) {
  // check if a win condition is met
  if (store.game.cells[0] !== '' && store.game.cells[0] === store.game.cells[1] && store.game.cells[1] === store.game.cells[2] || store.game.cells[3] !== '' && store.game.cells[3] === store.game.cells[4] && store.game.cells[4] === store.game.cells[5] || store.game.cells[6] !== '' && store.game.cells[6] === store.game.cells[7] && store.game.cells[7] === store.game.cells[8] || store.game.cells[0] !== '' && store.game.cells[0] === store.game.cells[3] && store.game.cells[3] === store.game.cells[6] || store.game.cells[1] !== '' && store.game.cells[1] === store.game.cells[4] && store.game.cells[4] === store.game.cells[7] || store.game.cells[2] !== '' && store.game.cells[2] === store.game.cells[5] && store.game.cells[5] === store.game.cells[8] || store.game.cells[0] !== '' && store.game.cells[0] === store.game.cells[4] && store.game.cells[4] === store.game.cells[8] || store.game.cells[6] !== '' && store.game.cells[6] === store.game.cells[4] && store.game.cells[4] === store.game.cells[2]) {
    // unbind all spaces
    $('.game-space').off('click');
    // set winner message
    var outcome = currentLetter.toUpperCase() + ' Wins!';
    showOutcome(outcome);
    return true;
...
var addLetter = function addLetter(e) {
  var arrayPos = void 0;
  ...
  var numberOfMoves = store.game.cells.filter(function (space) {
  ...
  if (store.game.cells[arrayPos].length === 0) {
    ...
    var newMove = { 'game': { 'cell': { 'index': arrayPos, 'value': currentLetter }, 'over': gameOver }
...
var newGame = function newGame() {
  ...
  api.newGameAPI().then(ui.newGameSuccess).catch(ui.newGameFailure);
  // reset game spaces
  $('.game-space').html('');
  // rebind addLetter
...
var newGameAPI = function newGameAPI() {
  return $.ajax({
...
var onShowGames = function onShowGames(e) {
  e.preventDefault();
